...
The [implement-plan workflow](../implement-plan/implement-plan.md) → `/commit` → the [validate-plan workflow](validate-plan.md) → the [describe-pr workflow](../describe-pr/describe-pr.md)
