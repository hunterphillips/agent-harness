---
name: search-domains
description: find ideal and available website domain names
---
...
2. Generate a list of candidate ideas for their domain name. Aim to generate about 50
   ...
   - A good domain name is:
     ...
     - Your candidate ideas should have about 75% using .com suffixes and 25% using alternate suffixes
       like .net, .biz, .io, .co, etc. Alternate suffixes should only be used when they make sense for the product and they fit well with the name.
